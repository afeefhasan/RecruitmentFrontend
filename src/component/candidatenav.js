    ...
    <Popover className="relative top-0 z-3 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 z-2 bg-gradient-to-r from-indigo-300 ...">
        <div className="flex justify-between items-center  border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <NavLink to="/candidatehome" className="mx-5  whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
            Home
            </NavLink>
            <NavLink to="/candidatecompany" className=" mx-5 whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
            Jobs
            </NavLink>
